...
A interpretação feita deste requisito foi no sentido de permitir ao RRH proceder à adição de um novo colaborador para que o mesmo possa aceder à plataforma de Serviços de Help Desk.
